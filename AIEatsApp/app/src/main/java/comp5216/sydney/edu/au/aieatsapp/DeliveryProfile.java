...
public class DeliveryProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPass = (EditText)findViewById(R.id.input_new_seller_password);
        submit = (Button)findViewById(R.id.seller_profile_submit);
        back =(Button) findViewById(R.id.seller_profile_back);
        //Init FireBase
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DeliveryProfile.this,foodAppDelivery.class));
                finish();
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newUsername.equals("") && newPassword.equals("")){
                    Toast.makeText(DeliveryProfile.this,"Please edit your username or password!",
                    ...
                    if (!newPassword.equals("")){
                        ...
                        Toast.makeText(DeliveryProfile.this,"Your Profile has successfully updated!",
                                Toast.LENGTH_SHORT).show();
                }
            }
        });
