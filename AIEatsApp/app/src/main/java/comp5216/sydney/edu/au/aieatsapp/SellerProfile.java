    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SellerProfile.this,foodAppSeller.class));
                finish();
            }
        });
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newUsername.equals("") && newPassword.equals("")){
                    Toast.makeText(SellerProfile.this,"Please edit your username or password!",
                    ...
                    if (!newPassword.equals("")){
                        ...
                        Toast.makeText(SellerProfile.this,"Your Profile has successfully updated!",
                                Toast.LENGTH_SHORT).show();
                }
            }
        });
