...
public class customerOrderAdapter extends ArrayAdapter<OrderFormat> {
    public customerOrderAdapter(Context context, ArrayList<OrderFormat> orderRecords) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.order_customer_list_layout, parent, false);
        }
